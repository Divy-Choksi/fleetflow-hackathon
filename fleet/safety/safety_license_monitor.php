...
// 2. Fetch driver license data
// 3. Identify expired licenses
// 4. Identify licenses expiring soon
// 5. Generate alert list
// 6. Prevent expired license drivers from dispatch
...
<head>
    ...
    <title>OptiFleet | License Monitoring</title>
...
<body class="h-screen flex selection:bg-brand-gold selection:text-black relative">
    ...
    <aside class="w-64 glass-panel flex flex-col z-20 shrink-0 border-r border-white/5 h-full hidden md:flex">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            ...
            <a href="safety_driver_compliance.php" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition-all">
    ...
    <div class="flex-1 flex flex-col h-full relative z-10 overflow-hidden">
        ...
        <header class="h-20 glass-panel flex items-center justify-between px-8 border-b border-white/5 shrink-0">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative hidden md:block">
                    ...
                    <input type="text" placeholder="Search license or driver..." class="bg-black/20 border border-white/10 rounded-full py-2 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-brand-gold w-64 transition-colors">
                </div>
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 pb-24">
            ...
            <!-- Header Section -->
            <div>
                <h2 class="text-3xl font-semibold text-white mb-2">License Monitoring</h2>
                <p class="text-gray-400 text-sm">Track license validity and upcoming expirations.</p>
            </div>

            <!-- Top Grid: KPI Cards + Warning Panel -->
            <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                
                <!-- Alert Summary Cards -->
                <div class="glass-card rounded-2xl p-5 relative overflow-hidden group">
                    <div class="absolute top-0 right-0 w-20 h-20 bg-status-info/5 rounded-bl-full -mr-4 -mt-4 transition-all group-hover:bg-status-info/10"></div>
                    <div class="flex justify-between items-start mb-3">
                        <div class="w-10 h-10 rounded-xl bg-status-info/10 flex items-center justify-center border border-status-info/20">
                            <i class="ph ph-identification-badge text-xl text-status-info"></i>
                        </div>
                    </div>
                    <h3 class="text-3xl font-bold text-white mb-1">142</h3>
                    <p class="text-sm text-gray-400 font-medium">Total Licenses Tracked</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-5 relative overflow-hidden group border-status-warning/30">
                    ...
                    <h3 class="text-3xl font-bold text-status-warning mb-1">5</h3>
                    <p class="text-sm text-status-warning/80 font-medium">Expiring Within 30 Days</p>
                </div>

                <!-- Warning Panel (Right Side) -->
                <div class="glass-panel rounded-2xl p-5 relative overflow-hidden md:col-span-1 border-brand-gold/20 flex flex-col justify-center">
                    <div class="absolute inset-0 bg-gradient-to-br from-brand-gold/10 via-transparent to-transparent opacity-50"></div>
                    <div class="relative z-10">
                        <div class="flex items-center gap-2 mb-3">
                            <i class="ph-fill ph-bell-ringing text-brand-gold text-xl animate-pulse"></i>
                            <h3 class="text-md font-semibold text-white">Action Alerts</h3>
                        </div>
                        <ul class="space-y-3">
                            <li class="flex items-start gap-2 text-sm">
                                <div class="w-1.5 h-1.5 rounded-full bg-status-danger mt-1.5 shrink-0"></div>
                                <p class="text-gray-300"><strong>3 licenses expired.</strong> Drivers automatically blocked from dispatch.</p>
                            </li>
                            <li class="flex items-start gap-2 text-sm">
                                <div class="w-1.5 h-1.5 rounded-full bg-status-warning mt-1.5 shrink-0"></div>
                                <p class="text-gray-300"><strong>5 licenses expiring within 30 days.</strong> Reminder emails sent.</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <!-- License Monitoring Table Main Section -->
            <section class="glass-panel rounded-3xl p-6 relative flex flex-col">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 shrink-0">
                    <div class="relative w-full sm:w-64">
                        <i class="ph ph-magnifying-glass absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                        <input type="text" placeholder="Search by name or license..." class="premium-input pl-10 text-sm w-full">
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse min-w-[1000px]">
                        ...
                        <tbody class="text-sm divide-y divide-white/5" id="licenseTableBody">
                            
                            <!-- Dummy Data Row 1 -->
                            <tr class="license-row hover:bg-white/5 transition-colors group" data-expiry="2028-10-12">
                                ...
                                <td class="py-4 text-gray-400">Commercial (Class A)</td>
                                <td class="py-4 text-center text-gray-400">12 Oct 2023</td>
                                <td class="py-4 text-center text-gray-300 font-medium">12 Oct 2028</td>
                                <td class="py-4 text-center font-medium days-remaining">--</td>
                                <td class="py-4 text-center pr-4 compliance-status">--</td>
                            </tr>
                            
                            <!-- Dummy Data Row 2 (Expired) -->
                            <tr class="license-row hover:bg-white/5 transition-colors group" data-expiry="2026-02-15">
                                ...
                                <td class="py-4 text-gray-400">Standard Delivery (Class C)</td>
                                <td class="py-4 text-center text-gray-400">15 Feb 2021</td>
                                <td class="py-4 text-center text-gray-300 font-medium">15 Feb 2026</td>
                                <td class="py-4 text-center font-medium days-remaining">--</td>
                                <td class="py-4 text-center pr-4 compliance-status">--</td>
                            </tr>

                            <!-- Dummy Data Row 3 (Expiring Soon) -->
                            <tr class="license-row hover:bg-white/5 transition-colors group" data-expiry="2026-03-05">
                                ...
                                <td class="py-4 text-center text-gray-300 font-medium">05 Mar 2026</td>
                                <td class="py-4 text-center font-medium days-remaining">--</td>
                                <td class="py-4 text-center pr-4 compliance-status">--</td>
                            </tr>
                            
                             <!-- Dummy Data Row 4 -->
                             <tr class="license-row hover:bg-white/5 transition-colors group" data-expiry="2027-06-20">
                                ...
                                <td class="py-4 text-center text-gray-300 font-medium">20 Jun 2027</td>
                                <td class="py-4 text-center font-medium days-remaining">--</td>
                                <td class="py-4 text-center pr-4 compliance-status">--</td>
                            </tr>

                             <!-- Dummy Data Row 5 (Expiring Soon) -->
                             <tr class="license-row hover:bg-white/5 transition-colors group" data-expiry="2026-03-12">
                                <td class="py-4 pl-4 font-medium text-gray-300">#D-309</td>
                                <td class="py-4 text-white">Linda Foster</td>
                                <td class="py-4 font-mono text-gray-300">DL-73918-FL</td>
                                <td class="py-4 text-gray-400">Cargo Van (Class B)</td>
                                <td class="py-4 text-center text-gray-400">12 Mar 2021</td>
                                <td class="py-4 text-center text-gray-300 font-medium">12 Mar 2026</td>
                                <td class="py-4 text-center font-medium days-remaining">--</td>
                                <td class="py-4 text-center pr-4 compliance-status">--</td>
                            </tr>
    ...
    <!-- Interactive Scripts -->
    <script>
        // --- Frontend Logic for Days Remaining & License Status Calculation ---
        document.addEventListener('DOMContentLoaded', () => {
            const rows = document.querySelectorAll('.license-row');
            // Mocking current date around hackathon timeline (Feb 21, 2026) 
            // for consistent testing of "Expiring Soon" and "Expired". 
            ...
            rows.forEach(row => {
                ...
                if (diffDays < 0) {
                    ...
                    // Expiring Soon (0 to 30 days)
                    row.classList.add('bg-status-warning/5', 'border-l-2', 'border-l-status-warning');
